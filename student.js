...
未回答の小問も省略せず、「未回答設問: 不正解」と書いてください。
形式例:
(1) 正解: [答え]
(2) 不正解: [答え]
...
[躓き明細]
不正解の小問のうち、生徒が何らかの回答・途中式・記述をしていて躓き原因を特定できるものだけ、「小問番号 | 躓き大分類 | 躓き小分類 | 原因詳細」の1行で出力してください。
未回答・空欄・読み取れないだけの小問は、躓き明細には出力しないでください。躓き明細に出力できる行がない場合は「なし」のみ。
大分類は「計算・式変形」「知識・解法」「問題の読み取り」「記述・提出」「その他」から1つ。小分類は、計算・式変形: 符号/計算/展開・因数分解/分数・約分/代入/その他、知識・解法: 公式/定義・性質/解法方針/場合分け/その他、問題の読み取り: 条件の見落とし/図表・グラフ/単位・範囲/その他、記述・提出: 答えの書き忘れ/途中式不足/判読不能/その他。`;
